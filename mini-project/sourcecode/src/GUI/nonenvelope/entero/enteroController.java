package GUI.nonenvelope.entero;
...
public class enteroController extends GeneralVirusController implements Initializable {
    private MediaPlayer mediaPlayer;
    private String path = "src/GUI/nonenvelope/entero/media/animation.mp4";
    @FXML
