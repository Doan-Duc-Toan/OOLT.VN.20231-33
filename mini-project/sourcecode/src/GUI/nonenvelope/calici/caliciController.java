...
public class caliciController extends GeneralVirusController implements Initializable {
    private MediaPlayer mediaPlayer;
    private String path = "src/GUI/nonenvelope/calici/media/animation.mp4";
    @FXML
